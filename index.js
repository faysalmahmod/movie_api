...
let allowedOrigins = ['http://localhost:8080/','https://faysalmahmod.github.io/myFlix-Angular-client/', 'http://testsite.com','http://localhost:1234','https://api-movie-myflix.herokuapp.com','https://internationalefilme.netlify.app','http://localhost:3000'];
app.use(cors({
